...
public class WebApplication {
	...
	public static void main(String[] args) {
        ...
        //             .toFriendlyString());
        //         log.info("Public Key: " + wallet().findKeyFromAddress(wallet().currentReceiveAddress())
        //             .getPublicKeyAsHex());
        //         // log.info("Private Key: " + wallet().findKeyFromAddress(wallet().currentReceiveAddress())
        //         //     .getPrivateKeyAsHex());
        ...
        //     });
        // kit.wallet()
        //     .addCoinsSentEventListener((wallet, tx, prevBalance, newBalance) -> log.info("new balance: " + newBalance.toFriendlyString()));
